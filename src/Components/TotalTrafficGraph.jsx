...
const TotalTrafficGraph = () => {
    ...
    async function getTotalTrafficDataFromAPI(daysAgo) {
        ...
        const response = await axios.get(`${baseUrl}/api/analytics/stats/total-users-graph?from=${from}&to=${to}`, {
            headers: {
...
export default TotalTrafficGraph
